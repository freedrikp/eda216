...
insert into Pallets(blocked,inFreezer,recipeName) values(false,false,'Nut ring');
insert into Pallets(blocked,inFreezer,recipeName) values(false,false,'Nut cookie');
insert into Pallets(blocked,inFreezer,recipeName) values(false,false,'Amneris');
insert into Pallets(blocked,inFreezer,recipeName) values(false,false,'Tango');
insert into Pallets(blocked,inFreezer,recipeName) values(false,false,'Almond delight');
insert into Pallets(blocked,inFreezer,recipeName) values(false,false,'Berliner');
