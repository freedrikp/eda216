...
% Du kan fylla på lite om order och production.
...
\section{User Manual}
\subsection{Setup}
To setup the website you will need some sort of server application that allows PHP and mySQL. Set the directory of the server to the \"phproot\"-folder, so the server runs our website properly. Start the server and the website should be up and running.
